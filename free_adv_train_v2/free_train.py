...
def train(tf_seed, np_seed, train_steps, out_steps, summary_steps, checkpoint_steps, step_size_schedule,
          weight_decay, momentum, train_batch_size, epsilon, replay_m, model_dir, dataset, poison_alpha, poison_config, **kwargs):
    ...
    poison_config_dict = utilities.config_to_namedtuple(utilities.get_config(poison_config))
