...
def get_args():
    ...
    parser.add("--dataset", "-d", type=str, default="cifar10_poisoned", choices=["cifar10", "cifar10_poisoned", "cifar100"], help="Path to load dataset, default=cifar10_poisoned")
    ...
    parser.add("--poison_alpha", type=float, default=0.0, help="Fraction of training set to poison, default=0.0")
    parser.add("--poison_config", type=str, default="poison_config.json", help="config for the data poisoning parameters")
